...
class KNearestNeighbor(object):
  ...
  def compute_distances_two_loops(self, X):
    ...
    for i in xrange(num_test):
      for j in xrange(num_train):
        ...
        #####################################################################
        # Using [i, :] gives entire row
        # Training is 5000 x 3072
        # Test is 500 x 3072
        dists[i,j] = np.sqrt(np.sum(X[i,:] - self.X_train[j,:])**2) # sqrt and square cancel?
        #####################################################################
        #                       END OF YOUR CODE                            #
        #####################################################################
    print (dists)
  ...
  def compute_distances_one_loop(self, X):
    ...
    for i in xrange(num_test):
      ...
      # 500 iterations
      #######################################################################
      dists[i,:] = np.sqrt(np.sum(X[i,:] - self.X_train, axis=1)**2)
      #######################################################################
      #                         END OF YOUR CODE                            #
      #######################################################################
    print (dists)
  ...
  def predict_labels(self, dists, k=1):
    ...
    for i in xrange(num_test):
      ...
      # label.                                                                #
      #########################################################################
      # argmax returns index of maximum item in array
